...
static struct platform_device tiny4412_device_leds = {
	.name	= "tiny4412-leds-gpio",
	.id		= -1,
	.resource = tiny4412_resource_leds,
	.num_resources = ARRAY_SIZE(tiny4412_resource_leds),
};
#endif
